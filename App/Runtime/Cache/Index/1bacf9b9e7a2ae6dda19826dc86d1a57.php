...
<html>
    ...
    <div class="mainNav">
        ...
        <div class="content">
            <div class="wrap">
                <h1 class="tit alc" style="margin:30px;">全部新闻</h1>
                <div class="faq" style="margin-left:100px;margin-right:100px;">
                    <?php if(is_array($news)): foreach($news as $key=>$v): ?><h3 style="margin-top:20px;margin-bottom:5px;"><a href="NewsDetail/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a><span><?php echo ($v["createtime"]); ?></span></h3>
